...
public class MergeSortMillions {
	...
	static void msMergeSort(MergeSort ms, MergeSortData[] inputArr, int length) {
        ms.array = inputArr;
        ms.length = length;
        ms.tempMergArr = new MergeSortData[ms.length];
        msDoSort(ms, 0, ms.length - 1);
    }
